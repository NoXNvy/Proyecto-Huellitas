    ...
    let currentSlide = 0;
        ...
        function handleHashNavigation() {
            ...
            if (hash) {
                ...
                // Si no hay hash, mostrar la primera sección .section (excepto si es la home)
                const sections = document.querySelectorAll('.section');
        ...
        function attachPetGridDelegation(){
            ...
            petsGrid.addEventListener('click', (e) => {
                if (e.target.matches('.btn-small')) {
                    ...
                    const type = card.querySelector('.pet-type') ? card.querySelector('.pet-type').textContent : '';
                    const age = card.querySelector('.pet-age') ? card.querySelector('.pet-age').textContent : '';
                    const desc = card.querySelector('.pet-description') ? card.querySelector('.pet-description').textContent : '';
